...
import sa.id.BioQA.domain.Sentence;
import sa.id.BioQA.domain.Word;
...
//                        System.out.println(definition);
    ...
    public double calculateOnlyUmlsScores(Word word1, Word word2) throws IOException {
    ...
    public double calculateUMLSScoreUsingWordnetInformation(Word word1 , Word word2) throws IOException {
        double similarityScore = 0.0;
    ...
    public double calculateCombinedSimilarityScore(Word word1 , Word word2) throws IOException {
...
//                System.out.println(word1.getWord() + " - " + word2.getWord() + " : " + umls_similarity_score);
    ...
    public Vector<Double> constructVectorForSentence(Sentence sentence, HashSet<Word> dictionary) throws IOException {
...
//        phrase = phrase.replace(" " , "");
    ...
    public double getSimilarityForWordnet(String sentence1, String sentence2) throws IOException {
