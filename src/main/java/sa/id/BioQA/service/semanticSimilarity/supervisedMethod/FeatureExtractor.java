...
public class FeatureExtractor {
    ...
    public void readParagraphVecFeature() throws IOException {
        BufferedReader buffer = new BufferedReader(new FileReader(BioQaApplication.class.getResource("/public/correlationResult/ourResults/paragraphVector.txt").getFile()));
        String line;
    ...
    public void readQGramFeature() throws IOException {
        BufferedReader buffer = new BufferedReader(new FileReader(BioQaApplication.class.getResource("/public/correlationResult/baselineResults/SW/qgramSW.txt").getFile()));
        String line;
        int currentPairIndex = 0;
        while((line=buffer.readLine())!= null){
            Pair currentPair = pairs.get(currentPairIndex);
    ...
    public void readGroundTruth() throws IOException {
        BufferedReader buffer = new BufferedReader(new FileReader(Resources.getResource("/public/correlationResult/groundTruth/test.txt").getFile()));
        String line;
        while((line=buffer.readLine())!= null){
    ...
    public void readCombineOntologyMethodFeature() throws IOException {
        ...
        BufferedReader buffer = new BufferedReader(new FileReader(Resources.getResource("/public/correlationResult/ourResults/combined/avgCombinedSw.txt").getFile()));
        String line;
        int currentPairIndex = 0;
        while((line=buffer.readLine())!= null){
            Pair currentPair = pairs.get(currentPairIndex);
