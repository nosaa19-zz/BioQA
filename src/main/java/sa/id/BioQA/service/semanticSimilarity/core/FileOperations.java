...
public class FileOperations {
    ...
    public HashMap<String, Double> readIDFScores() throws IOException {
        BufferedReader buffer = new BufferedReader(new FileReader(BioQaApplication.class.getResource("/public/idfScores/idf_values_tac_data.txt").getFile()));
        String line;
    ...
    public static List<String> readStopWordsList() throws IOException {
        ...
        BufferedReader bufferedReader = new BufferedReader(new FileReader(BioQaApplication.class.getResource("/public/stopWords/stop_words.txt").getFile()));
        String line;
