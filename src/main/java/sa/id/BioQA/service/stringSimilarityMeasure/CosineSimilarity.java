 ...
 */
package sa.id.BioQA.service.stringSimilarityMeasure;


import org.apache.log4j.Logger;
import sa.id.BioQA.domain.Distance;
...
public class CosineSimilarity extends Distance {
    ...
    public static Double calculateCosineSimilarity(Vector <Double> firstVector, Vector<Double> secondVector) {
        ...
        if(firstVector.size() != secondVector.size()){
            logger.error("The sizes of vectors given as parameters for cosine similarity are different.");
            return -1.0;
        }
